/**
 * Server-only brand configuration loader.
 *
 * This module MUST NOT be imported from client-side code or universal load functions.
 * It reads from the filesystem (brand.toml) and Node.js environment variables.
 *
 * See docs/spec/ux/branding.md and ADR-008.
 */
